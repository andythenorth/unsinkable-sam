...
class PassThroughPipeline(Pipeline):
    ...
    def render(self, variant, consist, global_constants):
        ...
        input_path = os.path.join(currentdir, 'src', 'graphics', 'ships', options['template'])
...
class ExtendSpriterowsForCompositedCargosPipeline(Pipeline):
    ...
    def render(self, variant, consist, global_constants):
        ...
        self.input_path = os.path.join(currentdir, 'src', 'graphics', 'ships', self.options['template'])
