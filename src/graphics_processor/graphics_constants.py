...
hull_recolor_CC1 = {136: CC1, 137: CC1+1, 138: CC1+2, 139: CC1+3, 140: CC1+4, 141: CC1+5, 142: CC1+6, 143: CC1+7}
hull_recolor_CC2 = {136: CC2, 137: CC2+1, 138: CC2+2, 139: CC2+3, 140: CC2+4, 141: CC2+5, 142: CC2+6, 143: CC2+7}
...
tanker_livery_recolour_maps = (("OIL_", {136: 1, 137: 2, 138: 3, 139: 4, 140: 5, 141: 6, 142: 7, 143: 8}), # see note on oil above
                               ("DFLT", hull_recolor_CC2), # see note on DFLT above
                               ("RFPR", hull_recolor_CC1),
...
piece_cargo_maps = ((['DFLT'], ['tarps_2cc_1']), # see note on DFLT above
                    ...
                    (['NUTS'], ['nuts']),
                    (['PAPR'], ['paper_coils']),
                    (['STEL', 'NICK', 'ALUM', 'METL'], ['steel_coils']),
                    (['WDPR'], ['lumber_planks']),
                    (['WOOD'], ['logs']))
